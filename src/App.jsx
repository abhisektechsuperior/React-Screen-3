...
import rentbox from './assets/rentboxhouse.jpg'
                    ...
                    <div class="container my-2">
                      <div class="row">
                        <div className='col-12'>
                          <div className='row'>
                            <div class="col-6 ">
                              <img className='img-1 ' src="https://homezonline.in/wp-content/uploads/2022/11/Outstanding-home-with-mind-blowing-interior.jpg" alt="" />
                            </div>
                            <div class="col-6">
                              <img className='img-1' src="https://www.bhg.com/thmb/H9VV9JNnKl-H1faFXnPlQfNprYw=/1799x0/filters:no_upscale():strip_icc()/white-modern-house-curved-patio-archway-c0a4a3b3-aa51b24d14d0464ea15d36e05aa85ac9.jpg" alt="" />
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className='row'>
                <div className='col-6'>
                  <div className='row mx-4 my-5'>
                    <div className='col-1'>
                      <img className='footerimage' src={insta} alt="" />
                    </div>
                    <div className='col-1'>
                      <img className='footerimage' src={facebook} alt="" />
                    </div>
                    <div className='col-1'>
                      <img className='footerimage' src={twitter} alt="" />
                    </div>
                  </div>
                </div>
              </div>
